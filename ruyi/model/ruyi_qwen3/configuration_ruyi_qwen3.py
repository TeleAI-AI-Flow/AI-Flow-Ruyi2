...
class RuyiQwen3Config(PretrainedConfig):

    model_type = "ruyi_qwen3"
    keys_to_ignore_at_inference = ["past_key_values"]

    # Default tensor parallel plan for base model `RuyiQwen3`
    base_model_tp_plan = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.auto_map = {
            "AutoConfig": "configuration_ruyi_qwen3.RuyiQwen3Config",
            "AutoModel": "modeling_ruyi_qwen3.RuyiQwen3Model",
            "AutoModelForCausalLM": "modeling_ruyi_qwen3.RuyiQwen3ForCausalLM"
        }
    ...
    def save_pretrained(self, save_directory, **kwargs):
        ...
        shutil.copyfile(
            ...
            os.path.join(save_directory, "configuration_ruyi_qwen3.py")
        )
